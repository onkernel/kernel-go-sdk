...
func (r *AppDeploymentService) FollowStreaming(ctx context.Context, id string, opts ...option.RequestOption) (stream *ssestream.Stream[AppDeploymentFollowResponse]) {
	var (
		raw *http.Response
		err error
	)
	...
	return ssestream.NewStream[AppDeploymentFollowResponse](ssestream.NewDecoder(raw), err)
}
...
type AppDeploymentFollowResponse = any
