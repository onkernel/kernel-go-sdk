...
func TestVaultProviderConfigGet(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.VaultProviderConfigs.Get(context.TODO(), "id_or_name")
	if err != nil {
		var apierr *kernel.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestVaultProviderConfigUpdateWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.VaultProviderConfigs.Update(
		context.TODO(),
		"id_or_name",
...
func TestVaultProviderConfigListWithOptionalParams(t *testing.T) {
	t.Skip("Mock server tests are disabled")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.VaultProviderConfigs.List(context.TODO(), kernel.VaultProviderConfigListParams{
		Limit:  kernel.Int(1),
		Offset: kernel.Int(0),
	})
	if err != nil {
...
func TestVaultProviderConfigDelete(t *testing.T) {
	...
	err := client.VaultProviderConfigs.Delete(context.TODO(), "id_or_name")
	if err != nil {
		var apierr *kernel.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
