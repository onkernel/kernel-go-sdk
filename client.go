...
type Client struct {
	...
	VaultProviderConfigs VaultProviderConfigService
	Vaults               VaultService
...
// environment (KERNEL_API_KEY, KERNEL_BASE_URL). The option passed in as arguments
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.ConfigRegistry = NewConfigRegistryService(opts...)
	...
	r.VaultProviderConfigs = NewVaultProviderConfigService(opts...)
